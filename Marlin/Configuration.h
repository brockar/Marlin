...
#define STRING_CONFIG_H_AUTHOR "Martin" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKi 24.61
  #define DEFAULT_bedKd 411.27
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80.1, 400, 415 }
// Extrusor comun { 80.0, 80.1, 400.0, 97.3 }
// BMG { 80, 80.1, 400.0, 415 }
// Default {80, 80, 400, 93}
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 10.0 // 7.0
  #define DEFAULT_YJERK 10.0 // 7.0
  #define DEFAULT_ZJERK  0.4 // 0.3
  #define DEFAULT_EJERK  5.0 // 5.0
...
#define X_MIN_POS 0
#define Y_MIN_POS -10 //-15 con BTT //-10 con petsfang
#define Z_MIN_POS 0
